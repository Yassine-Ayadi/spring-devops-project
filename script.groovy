...
def pushToNexus() {
    ...
    nexusArtifactUploader artifacts: [[artifactId: 'devops-project', classifier: '', file: 'target/devops-project-0.0.1-SNAPSHOT.jar', type: 'jar']], credentialsId: 'nexus-credentials', groupId: 'org.springframework.boot', nexusUrl: 'http://20.13.123.42/', nexusVersion: 'nexus3', protocol: 'http', repository: 'http://20.13.123.42:8081/repository/maven-releases/', version: '0.0.1-SNAPSHOT'
}
